...
Within the literature review, I will be introducing the game Pokemon Red, why I chose Pokemon Red, and the reason why I chose to conduct this research using RL. Lastly, I will be explaining the three algorithms I chose to compare the performance of and why I chose them.
...
Before explaining the theory behind the algorithms chosen, some important terms must be defined and explained before going into the theory of the algorithms.

Within the field of RL, there are two main types of algorithms, policy based and value based. Policy based algorithms are algorithms that learn the optimal policy by selecting the best action to take in a given state. Value based algorithms are algorithms that learn the optimal policy by selecting the best action to take in a given state by estimating the value of the state \cite{deepcheckRL}.

on and off policy 

Policy gradient

Advantage and Q learning 
