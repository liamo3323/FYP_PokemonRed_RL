...
class PkmnRedEnv(Env):
    def __init__(self, config = None): 
        ...
        # windows actions for interacting with the emulation
        self.valid_actions = [
    ...
    def step(self, action):
        ...
        new_reward, new_prog = self.reward()
        ...
        step_limit_reached = self.check_done()
    ...
    def group_rewards(self):
        ...
        return (prog['level'] * 100, self.read_hp_fraction()*2000, prog['explore'] * 160)
    ...
    def run_action_on_emulator(self, action):
        #! I need to figure out what different int values = which action! 
