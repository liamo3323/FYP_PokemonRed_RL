...
if __name__ == "__main__":
    ...
    num_cpu = 12 #! cannot go any higher than 12 <- also crashes after 3-4 hours
    episode_length_per_cpu = 2000 #? each episode will be 2000 steps long 
    ep_length = num_cpu * episode_length_per_cpu #? EPISODE LENGTH WILL BE 24,000
    total_timesteps = (ep_length)*1000 #? TOTAL TRAINING TIME WILL BE 24,000,000
