...
def make_model(algorithm):
    if algorithm == ("PPO"):
        ...
        model = QRDQN('MultiInputPolicy', env, verbose=1, n_steps=ep_length, gamma=gamma,
                     batch_size=batch_size, tensorboard_log=sess_path)
...
if __name__ == "__main__":
    ...
    env_config = {
            ...
            'gb_path': 'PokemonRed.gb', 'debug': False, 'reward_scale': 1, 'explore_weight': 0.5, 'battle_weight': 4,
